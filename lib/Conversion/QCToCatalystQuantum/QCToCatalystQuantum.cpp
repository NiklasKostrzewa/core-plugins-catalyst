 ...
 * The primary conversion is from !qc.qubit to !quantum.qubit as well as memref to !quantum.reg, which
 ...
 */
  ...
  struct ConvertMemRefAllocOp final
    ...
    matchAndRewrite(memref::AllocOp op, OpAdaptor adaptor,
      ...
      if (!memrefType || !llvm::isa<qc::QubitType>(op.getType().getElementType()) || llvm::isa<catalyst::quantum::QubitType>(op.getType().getElementType())) {
        return failure();
      }
